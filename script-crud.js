...
const removerTarefasConcluidas = document.querySelector('#btn-remover-concluidas');
...
removerTarefasConcluidas.onclick = () => removerTarefas(true);
removerTodasTarefas.onclick = () => removerTarefas(false);